...
#define CONFIG_SUPPPORT 20220729

#define FONT_FLASH_SIGN       20210829  //(YYYYMMDD) change if fonts require updating
#define CONFIG_FLASH_SIGN     20220729  //(YYYYMMDD) change if any keyword(s) in config.ini is added or removed		//TG 1/12/20 updated
#define LANGUAGE_FLASH_SIGN   20220729  //(YYYYMMDD) change if any keyword(s) in language pack is added or removed	//TG 7/27/22 updated
#define ICON_FLASH_SIGN       20220729  //(YYYYMMDD) change if any icon(s) is added or removed						//TG 7/27/22 updated
